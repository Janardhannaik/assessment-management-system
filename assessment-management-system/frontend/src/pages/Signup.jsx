...
//       const userInfo = { id: r.data.id, name, email };
//       localStorage.setItem("ams_new_user", JSON.stringify(userInfo));

//       setMsg("Account created! Redirecting to login...");
//       setTimeout(() => navigate("/login"), 500); // slight delay to ensure storage
//     } catch (err) {
//       setMsg(err?.response?.data?.error || "Error while signing up");
//     } finally {
//       setIsLoading(false);
//     }
//   }
...
//     if (msg.toLowerCase().includes("created")) return "text-green-400";
...
//       // Signup API call
//       const r = await signup({ name, email: normalizedEmail, password });

//       // Store user details in localStorage for instant login
...
//       setTimeout(() => navigate("/login"), 1000); // slight delay for UX
//     } catch (err) {
//       setMsg(err?.response?.data?.error || "Error while signing up");
//     } finally {
//       setIsLoading(false);
