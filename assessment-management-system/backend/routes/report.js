...
//       session,
//       assessmentTitle: session.assessment_id,
//       generatedAt: new Date().toLocaleString(),
//       sections: [], // add logic to map session data to sections if needed
//     });

//     const pdfPath = path.join(__dirname, "../reports", `${session_id}.pdf`);
