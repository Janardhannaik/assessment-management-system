...
//   // AUTO-GENERATE default session for new user
//   const defaultSessionId = `session_${uuidv4()}`;
//   const defaultSession = {
//     session_id: defaultSessionId,
//     assessment_id: "as_hr_02", // default assessment type
//     accuracy: 0,
//     weight: 0,
//     gender: "male",
//     bodyCompositionData: {},
...
//     timestamp: Date.now(),
//   };
//   DATA.push(defaultSession); // push in memory
//   // Optional: write to data.js or a DB file if needed
...
//     id: newUser.id,
//     token,
//     defaultSessionId, // send the session_id so frontend can generate report immediately
//   });
// });
